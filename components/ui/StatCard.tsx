...
const StatCard: React.FC<StatCardProps> = ({ icon: Icon, iconColor, label, value, helpKey, onHelpClick }) => (
    <div className="bg-slate-900/80 backdrop-blur-sm border border-white/10 rounded-xl md:rounded-2xl p-2.5 md:p-4 flex items-center gap-2 md:gap-4 md:hover:scale-[1.02] transition-all shadow-xl group relative">
