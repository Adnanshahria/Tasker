...
import { Trash2, Edit2, CheckCircle, HelpCircle, X } from 'lucide-react';
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className={`py-1.5 px-1.5 md:px-2 border-b ${rowBorderColor} border-r border-r-purple-500/20 bg-slate-900/80 sticky left-6 z-10 relative`}>
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                {item.description && (
                                                    <button
                                                        ...
                                                        className="p-0.5 text-slate-400 hover:text-amber-400 transition-colors ml-auto flex-shrink-0"
                                            ...
                                            {/* Description popup */}
                                            {showDescId === item.id && item.description && (
                                                <div className="absolute left-0 top-full mt-1 z-50 bg-slate-800 border border-slate-600 rounded-lg p-2 shadow-xl max-w-[200px] min-w-[150px]">
