                ...
                <table className="w-full text-left border-separate border-spacing-0 text-[10px] md:text-xs min-w-[650px]">
                    <thead className="sticky top-0 z-10">
                        <tr className="bg-gradient-to-r from-slate-800 via-slate-800/95 to-slate-800 text-slate-300 font-semibold uppercase tracking-wider">
                            ...
                            <th className="py-2 px-1.5 md:px-2 border-b-2 border-b-indigo-500/50 border-r border-r-purple-500/30 min-w-[100px] bg-slate-800 sticky left-6 z-20">{t.taskName}</th>
                        ...
                        <AnimatePresence>
                            {assignments.map((item, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Row Number */}
                                        <td className="py-1.5 px-1.5 md:px-2 text-center text-slate-500 font-mono text-[9px] border-b border-b-slate-700/60 border-r border-r-indigo-500/20 bg-slate-900/80 sticky left-0 z-10">
                                            {idx + 1}
                                        </td>

                                        {/* Task Name + Urgency */}
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-purple-500/20 bg-slate-900/80 sticky left-6 z-10">
                                        ...
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-blue-500/20">
                                        ...
                                        {/* Type - Colored Badge */}
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-cyan-500/20">
                                        ...
                                        {/* Due Date */}
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-teal-500/20">
                                        ...
                                        {/* Time */}
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-emerald-500/20">
                                        ...
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-amber-500/20">
                                        ...
                                        {/* Status Button */}
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-b-slate-700/60 border-r border-r-rose-500/20">
                                            <button
                                        ...
                                        {/* Actions */}
                                        <td className="py-1.5 px-1.5 md:px-2 text-center border-b border-b-slate-700/60">
