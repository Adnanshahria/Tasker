                        ...
                        <AnimatePresence>
                            {assignments.map((item, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Row Number */}
                                        <td className="py-1.5 px-1.5 md:px-2 text-center text-slate-500 font-mono text-[9px] border-b border-slate-700/30 bg-slate-900/80 sticky left-0 z-10">
                                            {idx + 1}
                                        </td>

                                        {/* Task Name + Urgency */}
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-slate-700/30 bg-slate-900/80 sticky left-6 z-10">
                                        ...
                                        <td className="py-1.5 px-1.5 md:px-2 border-b border-slate-700/30">
                                        ...
                                        {/* Actions */}
                                        <td className="py-1.5 px-1.5 md:px-2 text-center border-b border-slate-700/30">
